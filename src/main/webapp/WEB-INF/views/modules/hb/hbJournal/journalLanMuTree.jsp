	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            ...
		            {id:'${tpl.value}', pId:'${not empty tpl.parentId?tpl.parentId:0}', name:"<spring:message code="${tpl.label}"/>", url:"${ctx}/hb/hbJournal/list?journalV=${tpl.value}", target:"hbJournalMainFrame"},
		            </c:forEach>
		            ];
