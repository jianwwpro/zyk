	...
	var zhLanguage="${langType}";
		$(document).ready(function() {
			...
			$("#btnSaveAndApply").click(function(){
				$("#inputForm").attr("action","${ctx}/hb/hbActivity/saveAndApply?pageType=gg");
				$("#inputForm").submit();	
			});
...
<form id="uploadForm" action="${ctxFront}/uploadFile/upFile" enctype="multipart/form-data">
	...
	<ul class="nav nav-tabs">
		<li ><a href="${ctx}/hb/hbActivity/gg"><spring:message code='hb_activity.table2.title' text='hb_activity.table2.title' /><spring:message code="sys.list"/></a></li>
		<li class="active"><a href="${ctx}/hb/hbActivity/form?to=Gg&id=${hbActivity.id}"><spring:message code='hb_activity.table2.title' text='hb_activity.table2.title' /><spring:message code="sys.update"/></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hbActivity" action="${ctx}/hb/hbActivity/save" method="post" class="form-horizontal">
		...
		<input type="hidden" name="to" value="gg">
		<%--公告 --%>
