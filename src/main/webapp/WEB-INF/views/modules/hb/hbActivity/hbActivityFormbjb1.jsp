...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-footer">
    ...
    <button  id="tijiao" class="btn btn-primary">提交</button>
		...
		<%-- <div class="control-group">
			<label class="control-label"><spring:message code="sys.upload" text="sys.upload"/>：</label>
			<div class="controls">
			<span class="uploadBtn"><input type="button" value="选择图片" id="upFile" style="background:#666666;color:#fff;"></span>
			</div> --%>
		</div>
			<div class="control-group">
