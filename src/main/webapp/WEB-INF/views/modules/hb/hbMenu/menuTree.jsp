...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${categoryList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${langType eq 'zh'?tpl.name:tpl.ename}", url:"${ctx}/hb/hbArticle/?menu.id=${tpl.id}", target:"cmsMainFrame"},
		            </c:forEach>];
		...
		/* 	// 展开第二级节点
			...
			top.$("#cmsMainFrame").attr("src",nodes[0].url);
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle"><spring:message code='hb_articls.column_manage' text='hb_articls.column_manage' /></a>
	    </div>
