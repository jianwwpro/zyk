	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand">
				<span id="productName" ><%-- ${fns:getConfig('productName')} --%>
				<img alt="" src="${ctxStatic }/images/logo.png" style="height:40px;width:150px; margin-top: -10px">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="countrySwitch" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="语种切换"><i class="icon-flag"></i></a>
						<ul class="dropdown-menu">
							<li><a href="${ctx }?langType=zh">中文</a></li>
							<li><a href="${ctx }?langType=en">英文</a></li>
							...
							<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
								<li class="menu ${not empty firstMenu && firstMenu ? ' active' : ''}">
									<c:if test="${empty menu.href}">
										<a class="menu" href="javascript:" data-href="${ctx}/sys/menu/tree?parentId=${menu.id}" data-id="${menu.id}"><span><spring:message code='${menu.name}' text='${menu.name}' /></span></a>
									</c:if>
									<c:if test="${not empty menu.href}">
										<a class="menu" href="${fn:indexOf(menu.href, '://') eq -1 ? ctx : ''}${menu.href}" data-id="${menu.id}" target="mainFrame"><span><spring:message code='${menu.name}' text='${menu.name}' /></span></a>
									</c:if>
								</li>
								<c:if test="${firstMenu}">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} <!-- - Powered By <a href="" target="_blank">Xiaozhu</a> --> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
