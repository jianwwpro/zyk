...
import com.jee.site.modules.act.dao.ActDao;
import com.jee.site.modules.act.entity.Act;
import com.jee.site.modules.act.utils.ActUtils;
import com.jee.site.modules.act.utils.ProcessDefCache;
...
//			e.setProcExecUrl(ActUtils.getProcExeUrl(task.getProcessDefinitionId()));
	...
	public Page<Act> historicList(Page<Act> page, Act act){
		...
		List<HistoricTaskInstance> histList = histTaskQuery.listPage((page.getPageNo()-1)*page.getPageSize(), page.getMaxResults());
		
		for (HistoricTaskInstance histTask : histList) {
			List<HistoricVariableInstance> list = historyService.createHistoricVariableInstanceQuery().processInstanceId(histTask.getProcessInstanceId()).list();
