 ...
 * 
 */
package com.jee.site.modules.act.service.ext;
...
import com.jee.site.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.jee.site.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.jee.site.modules.sys.entity.User(null, userId)))){
