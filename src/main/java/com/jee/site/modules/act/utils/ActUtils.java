 ...
 * 
 */
package com.jee.site.modules.act.utils;
...
import com.jee.site.common.annotation.FieldName;
import com.jee.site.common.config.Global;
import com.jee.site.common.utils.Encodes;
...
import com.jee.site.modules.sys.entity.Role;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	//文章审批流程
	public static final String[] ARTICLE_AUDIT = new String[]{"HB_ARTICLE_PROCESS", "hb_article"};
	//博文审批流程
	public static final String[] BLOG_AUDIT = new String[]{"HB_BLOG_PROCESS", "hb_blog"};
	//博文审批流程
	public static final String[] ACTIVITY_AUDIT = new String[]{"HB_ACTIVITY_PROCESS", "hb_activity"};
	//博文审批流程
	public static final String[] CONTRIBUTE_AUDIT = new String[]{"HB_CONTRIBUTE_PROCESS", "hb_contribute"};
	//期刊
	public static final String[] JOURNAL_AUDIT = new String[]{"HB_JOURNAL_AUDIT", "hb_journal"};
