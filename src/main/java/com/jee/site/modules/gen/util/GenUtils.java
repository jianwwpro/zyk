 ...
 * 
 */
package com.jee.site.modules.gen.util;
...
import com.jee.site.common.mapper.JaxbMapper;
import com.jee.site.common.utils.DateUtils;
import com.jee.site.common.utils.FileUtils;
import com.jee.site.common.utils.FreeMarkers;
import com.jee.site.common.utils.StringUtils;
import com.jee.site.modules.gen.entity.GenCategory;
import com.jee.site.modules.gen.entity.GenConfig;
...
//		}
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
		// 获取生成文件
		if(
		tpl.getFileName().endsWith("jsp")
		){
			tpl.setFilePath(tpl.getFilePath()+"${className}");
		}
